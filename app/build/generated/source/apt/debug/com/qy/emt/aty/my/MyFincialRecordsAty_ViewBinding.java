...
public class MyFincialRecordsAty_ViewBinding implements Unbinder {
  private MyFincialRecordsAty target;

  @UiThread
  public MyFincialRecordsAty_ViewBinding(MyFincialRecordsAty target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public MyFincialRecordsAty_ViewBinding(MyFincialRecordsAty target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MyFincialRecordsAty target = this.target;
