...
public class UserRedemptionRecordsAty_ViewBinding implements Unbinder {
  private UserRedemptionRecordsAty target;

  @UiThread
  public UserRedemptionRecordsAty_ViewBinding(UserRedemptionRecordsAty target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public UserRedemptionRecordsAty_ViewBinding(UserRedemptionRecordsAty target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    UserRedemptionRecordsAty target = this.target;
