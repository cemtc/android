...
public class UserTangguoAty_ViewBinding implements Unbinder {
  private UserTangguoAty target;

  @UiThread
  public UserTangguoAty_ViewBinding(UserTangguoAty target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public UserTangguoAty_ViewBinding(UserTangguoAty target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    UserTangguoAty target = this.target;
