...
public class UserZhongchuAty_ViewBinding implements Unbinder {
  private UserZhongchuAty target;

  @UiThread
  public UserZhongchuAty_ViewBinding(UserZhongchuAty target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public UserZhongchuAty_ViewBinding(UserZhongchuAty target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    UserZhongchuAty target = this.target;
