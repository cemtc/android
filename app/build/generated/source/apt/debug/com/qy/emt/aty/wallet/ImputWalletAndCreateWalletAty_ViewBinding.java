...
public class ImputWalletAndCreateWalletAty_ViewBinding implements Unbinder {
  private ImputWalletAndCreateWalletAty target;
  ...
  @UiThread
  public ImputWalletAndCreateWalletAty_ViewBinding(ImputWalletAndCreateWalletAty target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ImputWalletAndCreateWalletAty_ViewBinding(final ImputWalletAndCreateWalletAty target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ImputWalletAndCreateWalletAty target = this.target;
