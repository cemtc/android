...
public class PrivateKeyImportAty_ViewBinding implements Unbinder {
  private PrivateKeyImportAty target;
  ...
  @UiThread
  public PrivateKeyImportAty_ViewBinding(PrivateKeyImportAty target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PrivateKeyImportAty_ViewBinding(final PrivateKeyImportAty target, View source) {
    this.target = target;
    ...
    target.wallet_pass_id = Utils.findRequiredViewAsType(source, R.id.wallet_pass_id, "field 'wallet_pass_id'", EditText.class);
    target.wallet_pass_conf_id = Utils.findRequiredViewAsType(source, R.id.wallet_pass_conf_id, "field 'wallet_pass_conf_id'", EditText.class);
  ...
  @CallSuper
  public void unbind() {
    PrivateKeyImportAty target = this.target;
    ...
    target.wallet_pass_id = null;
    target.wallet_pass_conf_id = null;
