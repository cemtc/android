...
public class VerificationMnemonicAty_ViewBinding implements Unbinder {
  private VerificationMnemonicAty target;

  private View view2131296857;

  @UiThread
  public VerificationMnemonicAty_ViewBinding(VerificationMnemonicAty target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public VerificationMnemonicAty_ViewBinding(final VerificationMnemonicAty target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    VerificationMnemonicAty target = this.target;
