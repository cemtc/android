...
public class WalletMarketAty_ViewBinding implements Unbinder {
  private WalletMarketAty target;

  @UiThread
  public WalletMarketAty_ViewBinding(WalletMarketAty target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public WalletMarketAty_ViewBinding(WalletMarketAty target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    WalletMarketAty target = this.target;
