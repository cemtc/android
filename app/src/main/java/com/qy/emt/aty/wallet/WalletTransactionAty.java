...
import com.qy.emt.R;
import com.qy.emt.adapter.other.TransListAdapter;
import com.qy.emt.adapter.other.TransListETHBTCAdapter;
import com.qy.emt.aty.base.BaseAty;
import com.qy.emt.bean.other.entity.WalletToken;
import com.qy.emt.bean.wallet.BtcRecordBean;
import com.qy.emt.bean.wallet.EthRecordBean;
...
//            initNum(txsList.size());
    ...
    private void requestData(int type) {
        ...
        if (type == 0) {
            ...
            if ("EMTC".equals(walletToken.getTokenName())) {
