...
import com.qy.emt.R;
import com.qy.emt.adapter.other.MarketAdapter;
...
public class MarketFrag extends BaseFrag implements OnRefreshListener, HttpRequestCallback<Object> {
    ...
    public void fillData() {
        ...
        nllWalletMarket.setTitle("market");
...
//        jsonArray1.addAll(jsonArray);
    ...
    public void marketHttp1(){
        getHttp("https://mdncapi.bqiapp.com/api/coin/web-coinrank?webp=1&pagesize=100&page=1&type=-1",null);
    }
    @Override
    public void onHttpSuccess(String result, String url) {
        ...
        dialogUtils.dismissProgressDialog();
        marketAdapter.setqOrgs(jsonArray);
        marketAdapter.notifyDataSetChanged();
    }
}
