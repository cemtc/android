package com.qy.emt.utils.blockchain;
...
import com.qy.emt.other.thread.GetCurrencyBalance;
import com.qy.emt.other.thread.GetETHCurrencyBalance;
...
public class BlockChainUtils {
    ...
    public static void getBlockchain() {
        ...
        List<WalletBean> localWalletList = DatabaseWalletUtils.getLocalCoinList_CCM("EMTC");
