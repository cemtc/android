package com.qy.emt.utils.blockchain.btc;
...
import com.qy.emt.utils.http.Http;
import com.qy.emt.utils.http.OnSuccessAndFaultListener;
import com.qy.emt.utils.http.OnSuccessAndFaultSub;
...
import static com.qy.emt.constants.UrlConstants.BTC_BASE_API;
            ...
            public void onSuccess(String result, String url) {
                try {
                    ...
                    if (outputs == null || outputs.size() == 0) {
                        com.qy.emt.utils.Utils.Toast("交易异常，余额不足");
                    }
