package com.qy.emt.utils.blockchain.eth;
...
public class CCMUtils {
    ...
    private void tokenList(String ethAddress, String mnemonics, String privateKey, String password, String mobileMapping, String walletName) {
        ...
        //CCM
        WalletCoinUtils.setCoinData("EMTC", ethAddress, Config.getMobleMapping());
        DatabaseWalletUtils.setLocalCoinJson("https://raw.githubusercontent.com/iozhaq/image/master/EMTC.png", "EMTC", "EMTC", ethAddress, "", encodeMnemonics, encodePrivateKey, BigDecimal.ZERO, BigDecimal.ZERO, true, mobileMapping, walletName, "EMTC");
//        //SAR
//        WalletCoinUtils.setCoinData("SAR", ethAddress, Config.getMobleMapping());
//        DatabaseWalletUtils.setLocalCoinJson("https://raw.githubusercontent.com/iozhaq/image/master/SAR.png", "SAR", "SAR", ethAddress, EthConfig.SAR_CONTRACT, encodeMnemonics, encodePrivateKey, BigDecimal.ZERO, BigDecimal.ZERO, true, mobileMapping, walletName, "EMTC");
//        //SAR-ASI
//        WalletCoinUtils.setCoinData("SAR-ASI", ethAddress, Config.getMobleMapping());
//        DatabaseWalletUtils.setLocalCoinJson("https://raw.githubusercontent.com/iozhaq/image/master/SAR-ASI.png", "SAR-ASI", "SAR-ASI", ethAddress, EthConfig.SAR_ASI_CONTRACT, encodeMnemonics, encodePrivateKey, BigDecimal.ZERO, BigDecimal.ZERO, true, mobileMapping, walletName, "EMTC");
////        //CCM-ISR
//        WalletCoinUtils.setCoinData("CCM-ISR", ethAddress, Config.getMobleMapping());
//        DatabaseWalletUtils.setLocalCoinJson("https://raw.githubusercontent.com/iozhaq/image/master/CCM-ISR.png", "CCM-ISR", "CCM-ISR", ethAddress, EthConfig.CCM_ISR_CONTRACT, encodeMnemonics, encodePrivateKey, BigDecimal.ZERO, BigDecimal.ZERO, true, mobileMapping, walletName, "EMTC");
////        //SAR-SAN
//        WalletCoinUtils.setCoinData("SAR-SAN", ethAddress, Config.getMobleMapping());
//        DatabaseWalletUtils.setLocalCoinJson("https://raw.githubusercontent.com/iozhaq/image/master/SAR-SAN.png", "SAR-SAN", "SAR-SAN", ethAddress, EthConfig.SAR_SAN_CONTRACT, encodeMnemonics, encodePrivateKey, BigDecimal.ZERO, BigDecimal.ZERO, true, mobileMapping, walletName, "EMTC");
////        //HKDD
//        WalletCoinUtils.setCoinData("HKDD", ethAddress, Config.getMobleMapping());
//        DatabaseWalletUtils.setLocalCoinJson("https://raw.githubusercontent.com/iozhaq/image/master/HKDD.png", "HKDD", "HKDD", ethAddress, EthConfig.HKDD_CONTRACT, encodeMnemonics, encodePrivateKey, BigDecimal.ZERO, BigDecimal.ZERO, true, mobileMapping, walletName, "EMTC");
////        //SAR-S, mobileMapping
//        WalletCoinUtils.setCoinData("SAR-S", ethAddress, Config.getMobleMapping());
//        DatabaseWalletUtils.setLocalCoinJson("https://raw.githubusercontent.com/iozhaq/image/master/SAR-S.png", "SAR-S", "SAR-S", ethAddress, EthConfig.SAR_S_CONTRACT, encodeMnemonics, encodePrivateKey, BigDecimal.ZERO, BigDecimal.ZERO, true, mobileMapping, walletName, "EMTC");
////        //ISR-S, mobileMapping
//        WalletCoinUtils.setCoinData("ISR-S", ethAddress, Config.getMobleMapping());
//        DatabaseWalletUtils.setLocalCoinJson("https://raw.githubusercontent.com/iozhaq/image/master/ISR-S.png", "ISR-S", "ISR-S", ethAddress, EthConfig.ISR_S_CONTRACT, encodeMnemonics, encodePrivateKey, BigDecimal.ZERO, BigDecimal.ZERO, true, mobileMapping, walletName, "EMTC");
////        //CCM-S, mobileMapping
//        WalletCoinUtils.setCoinData("CCM-S", ethAddress, Config.getMobleMapping());
//        DatabaseWalletUtils.setLocalCoinJson("https://raw.githubusercontent.com/iozhaq/image/master/CCM-S.png", "CCM-S", "CCM-S", ethAddress, EthConfig.CCM_S_CONTRACT, encodeMnemonics, encodePrivateKey, BigDecimal.ZERO, BigDecimal.ZERO, true, mobileMapping, walletName, "EMTC");
////        //SAR-ES, mobileMapping
//        WalletCoinUtils.setCoinData("SAR-ES", ethAddress, Config.getMobleMapping());
//        DatabaseWalletUtils.setLocalCoinJson("https://raw.githubusercontent.com/iozhaq/image/master/SAR-ES.png", "SAR-ES", "SAR-ES", ethAddress, EthConfig.SAR_ES_CONTRACT, encodeMnemonics, encodePrivateKey, BigDecimal.ZERO, BigDecimal.ZERO, true, mobileMapping, walletName, "EMTC");
////        //HKDD-S, mobileMapping
//        WalletCoinUtils.setCoinData("HKDD-S", ethAddress, Config.getMobleMapping());
//        DatabaseWalletUtils.setLocalCoinJson("https://raw.githubusercontent.com/iozhaq/image/master/HKDD-S.png", "HKDD-S", "HKDD-S", ethAddress, EthConfig.HKDD_S_CONTRACT, encodeMnemonics, encodePrivateKey, BigDecimal.ZERO, BigDecimal.ZERO, true, mobileMapping, walletName, "EMTC");
////  add  new   =========================================================================
